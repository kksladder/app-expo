...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView style={[styles.container, isDarkMode && styles.darkContainer]}>
            <ImageBackground source={{ uri: 'https://picsum.photos/400/800' }} style={styles.backgroundImage}>
                <ScrollView refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
                    {/* 현재 날씨 */}
                    <View style={styles.currentWeather}>
                        <Text style={[styles.temp, isDarkMode && styles.darkText]}>{weatherData.current.temp}°C</Text>
                    ...
                    <View style={styles.settingsContainer}>
                        <Text style={[styles.settingsText, isDarkMode && styles.darkText]}>다크모드</Text>
                        <Switch
                            value={isDarkMode}
                    ...
                    {/* 시간별 날씨 */}
                    <Text style={[styles.hourlyTitle, isDarkMode && styles.darkText]}>시간별 날씨</Text>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        {weatherData.hourly.map((item, index) => (
                            <Pressable key={index} style={styles.hourlyItem} onPress={() => setModalVisible(true)}>
